...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x42, 0x00, 2, 64}, // GREEN  16
    {0x50, 0x00, 2, 64}, // YEELOW
    {0x44, 0x00, 2, 64}, // BLUE
    {0x41, 0x00, 2, 64}, // HOME
    {0x45, 0x00, 2, 64}, // HOME

    {0x24, 0x02, 2, 64}, // GREEN  16
    {0x43, 0x00, 2, 64}, // YEELOW
    {0x49, 0x00, 2, 64}, // BLUE
    {0x21, 0x02, 2, 64}, // HOME
    {0xE9, 0x00, 2, 64}, // HOME

    {0x9C, 0x00, 2, 64}, // GREEN  16
    {0x52, 0x00, 2, 64}, // YEELOW
    {0xEA, 0x00, 2, 64}, // BLUE
    {0x9D, 0x00, 2, 64}, // HOME
    {0x53, 0x00, 2, 64}, // HOME

    {0x58, 0x00, 2, 64}, // GREEN  16
    {0x51, 0x00, 2, 64}, // YEELOW
    {0x57, 0x00, 2, 64}, // BLUE 
};
#elif (Project_key == 406)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x4F, 0x00, 2, 64}, // GREEN  16
    {0x5F, 0x00, 2, 64}, // YEELOW
    {0x4D, 0x00, 2, 64}, // BLUE 
};
#elif (Project_key == 407)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x53, 0x00, 2, 64}, // GREEN  16
    {0x37, 0x00, 2, 64}, // YEELOW
    {0x38, 0x00, 2, 64}, // BLUE 
};
#elif (Project_key == 410)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x38, 0x00, 2, 64}, // GREEN  16
    {0x51, 0x00, 2, 64}, // YEELOW
    {0x57, 0x00, 2, 64}, // BLUE 
};
#elif (Project_key == 411)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x57, 0x00, 2, 64}, // GREEN  16
    {0x4E, 0x00, 2, 64}, // YEELOW
    {0x5F, 0x00, 2, 64}, // BLUE 
};
#endif
...
#if (Project_key == 405)
static uint8_t adv_data_buf[] = {0x02, 0x01, 0x06, 0x05, 0xff, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0a, 0x03, 0x0e, 0x09, 0x54, 0x43, 0x4c, 0x5f, 0x52, 0x43, 0x39, 0x30, 0x31, 0x56, 0x5f, 0x4D, 0x31};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};


#elif (Project_key == 406)//
static uint8_t adv_data_buf[] = {0x02, 0x01, 0x06,0x05, 0xff, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0a, 0x03, 0x0e, 0x09, 0x54, 0x43, 0x4c, 0x5f, 0x52, 0x43, 0x39, 0x30, 0x31, 0x56, 0x5f, 0x41, 0x31};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};
#elif (Project_key == 407)//
static uint8_t adv_data_buf[] = {0x02, 0x01, 0x06,0x05, 0xff, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0a, 0x03, 0x0e, 0x09, 0x54, 0x43, 0x4c, 0x5f, 0x52, 0x43, 0x39, 0x30, 0x31, 0x56, 0x5f, 0x41, 0x31};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};
...
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};
#elif (Project_key == 409)//
static uint8_t adv_data_buf[] = {0x02, 0x01, 0x06,0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x0E, 0x09, 0x54, 0x43, 0x4C, 0x5F, 0x52, 0x43, 0x39, 0x30, 0x31, 0x56, 0x5F, 0x4D, 0x44};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};
#elif (Project_key == 410)//
static uint8_t adv_data_buf[] = {0x02, 0x01, 0x06,0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x0E, 0x09, 0x54, 0x43, 0x4C, 0x5F, 0x52, 0x43, 0x39, 0x30, 0x31, 0x56, 0x5F, 0x4D, 0x44};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};
#elif (Project_key == 411)//
static uint8_t adv_data_buf[] = {0x02, 0x01, 0x06,0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x0E, 0x09, 0x54, 0x43, 0x4C, 0x5F, 0x52, 0x43, 0x39, 0x30, 0x31, 0x56, 0x5F, 0x4D, 0x45};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0x80, 0x01};
#endif
...
void app_init(void)
{
    if (!Lpm_GetWakeFlag())
    {
        ...
        bt_update_dle();     
        bt_set_ce_length_num(0x08);//0x08
        software_timer_start(SYSTEM_CURRENT_CLOCK, 10);
        app_sleep_init();
        vbat_init(power_handle);
        led_init();
        voice_report_init();
        ir_init(RCA_38_43, HIGH_CUSTOM_FFFD_E000_A);
