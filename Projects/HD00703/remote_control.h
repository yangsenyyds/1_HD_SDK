...
/* SOFTWARE TIMER */
#define TIMER_NUM       (11)   // KEY 1, LED 1, VBAT 1, VOICE 2, SLEEP 1, REMOTE_CONTROL 2, +1
...
#define MSBC                    (1)
#define VIZIO                   (1) 
#define NO_ENCODE_OUTPUT_SIZE   (1)
#define MICRECORD_CACHE_NUM     (10)//大小
#define ENCODE_CACHE_NUM        (10)//包数
#define ENCODE_TIMES_ONCE       (1)//循环次数
#define ENCODE_INPUT_SIZE       (228)//每次采集大小 4:1
#define ENCODE_OUTPUT_SIZE      (60)//每次编码大小
#define AUDIO_SEND_NTF_SIZE     (120)//发送大小
#define AUDIO_FRAME_HEADER_LEN  (2)//偏移
#define AUDIO_NTF_BUFSIZE       (AUDIO_FRAME_HEADER_LEN + AUDIO_SEND_NTF_SIZE)

#define TIMEOUT_TIME            (15000)

#define AUDIO_SNED_HANDLE       (51)
#define AUDIO_CTOL_HANDLE       (55)
/* IR */
#define IR_IO           (GPIO_4)
