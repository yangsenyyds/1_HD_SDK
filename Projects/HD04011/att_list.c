...
static const uint8_t model_number_value[] = {"ERF3Z80H"};
//generic access
...
static const uint8_t Serial_number_string_value[] = {"201809070000"};
static const uint8_t CHRCTR_Firmware_Revision_String[] = {UUID2ARRAY(UUID_CHRCTR_FIRMWARE)};
static const uint8_t Firmware_Revision_String_value[] = {"V2.0"};
...
static const uint8_t Software_Revision_String_value[] = {"V3.06"};
