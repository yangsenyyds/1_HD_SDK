...
static const uint8_t device_name[] = {"SmartRC"};
...
static const uint8_t model_number_value[] = {"ERF3M90H"};
//generic access
...
static const uint8_t Serial_number_string_value[] = {"202203170000"};
static const uint8_t CHRCTR_Firmware_Revision_String[] = {UUID2ARRAY(UUID_CHRCTR_FIRMWARE)};
static const uint8_t Firmware_Revision_String_value[] = {"v1.2"};
...
static const uint8_t Software_Revision_String_value[] = {"1.06"};

static const uint8_t CHRCTR_Manufacturer_Name_String[] = {UUID2ARRAY(UUID_CHRCTR_MANUFACTURE_NAME)};
static const uint8_t Manufacturer_Name_String_value[] = {"SmartRC"};
...
const ATT_TABLE_TYPE Att_List[] =
{
	...
	// {30, 2, GATT_CHARACTERISTIC, 1, NOTIFY_READ_WRITE_WITHOUT_RESPONSE_PREMITTED},
