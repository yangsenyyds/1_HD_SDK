...
#if (Project_key == 614)
// #if defined(PRIMEVIDEO_NETFLIX_DISNEP_HULU)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x37,0x00};
#elif (Project_key == 615)
// #elif defined(PRIMEVIDEO_NETFLIX_APPS_AMAZONMUSIC)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x3A,0x00};
#elif (Project_key == 616)
// ///功能键PRIME VIDEO NETFLIX,DAZN,AMAZON MUSIC
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x39,0x00};
#elif (Project_key == 617)
// #elif defined(PRIMEVIDEO_NETFLIX_APPS_AMAZONMUSIC)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x3B,0x00};
#endif
