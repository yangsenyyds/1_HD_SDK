...
static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06 ,0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x06, 0x09, 0x52, 0x43, 0x38, 0x39, 0x30, 0x03, 0x19, 0xC1, 0x03};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0xC1, 0x03};
#elif (Project_key == 417)//
// static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06 ,0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x06, 0x09, 0x52, 0x43, 0x38, 0x39, 0x30, 0x03, 0x19, 0xC1, 0x03};
// static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0xC1, 0x03};
static uint8_t adv_data_buf[] = {0x05, 0xff, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0a, 0x03, 0x06, 0x09, 0x52, 0x43, 0x38, 0x39, 0x30, 0x03, 0x19, 0xc1, 0x03};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0xc1, 0x03};
static const uint8_t ir_data[] = {
    0x00,
