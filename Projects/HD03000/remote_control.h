...
/* SOFTWARE TIMER */
#define TIMER_NUM       (11)   //KEY 1, LED 1, VBAT 1, VOICE 2, SLEEP 1, REMOTE_CONTROL 3, +1
#define TIMER_UNIT_MS   (10)

/* POWER */
#define BAT_REPORT_HANDLE   (50)
#define BAT_ATTLIST_INDEX   (48)
/* KEY */
