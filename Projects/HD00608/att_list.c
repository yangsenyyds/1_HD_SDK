...
#if (Project_key == 604)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x38,0x00};//PRIME_VIDEO_NETFLIX_DISNEP_AMAZONMUSIC
#elif (Project_key == 605)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x39,0x00};//PRIMEVIDEO_NETFLIX_DAZN_AMAZONMUSIC
#elif (Project_key == 606)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x3A,0x00};//PRIMEVIDEO_NETFLIX_APPS_AMAZONMUSIC
#elif (Project_key == 608)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x37,0x00};//PRIMEVIDEO_NETFLIX_DISNEP_HULU
#elif (Project_key == 620)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x14,0x04,0x16,0x00};//PRIMEVIDEO_NETFLIX_hbo_HULU
#elif (Project_key == 623)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x55,0x00};//prime video netflix dazn abema
#elif (Project_key == 955)
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x1E,0x04,0x61,0x00};//prime video netflix dazn abema
#endif
static const uint8_t CHRCTR_MANUFACTURE_NAME[] = {UUID2ARRAY(UUID_CHRCTR_MANUFACTURE_NAME)};
static const uint8_t manufacture_name_value[] = {0x41,0x6D,0x61,0x7A,0x6F,0x6E,0x20,0x52,0x65,0x6D,0x6F,0x74,0x65,0x00};
static const uint8_t CHRCTR_SOFTWARE[] = {UUID2ARRAY(UUID_CHRCTR_SOFTWARE)};
static const uint8_t software_value[] = {0x31,0x32,0x33};
static const uint8_t CHRCTR_HARDWARE[] = {UUID2ARRAY(UUID_CHRCTR_HARDWARE)};
static const uint8_t hardware_value[] = {0x50,0x56,0x54};
static const uint8_t CHRCTR_FIRMWARE[] = {UUID2ARRAY(UUID_CHRCTR_FIRMWARE)};
static const uint8_t firmware_value[] = {0x35,0x32,0x35,0x31,0x39,0x39,0x30,0x31};//版本号199
static const uint8_t CHRCTR_SERIAL_NUMBER[] = {UUID2ARRAY(UUID_CHRCTR_SERIAL_NUMBER)};
static const uint8_t serial_number_value[] = {0x47,0x30,0x47,0x31,0x55,0x36,0x30,0x31,0x31,0x32,0x34,0x33,0x30,0x32,0x31,0x45};
static const uint8_t CHRCTR_MODEL_NUMBER[] = {UUID2ARRAY(UUID_CHRCTR_MODEL_NUMBER)};
static const uint8_t model_number_value[] = {0x4D,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39};
static const uint8_t CHRCTR_SYSTEM_ID[] = {UUID2ARRAY(UUID_CHRCTR_SYSTEM_ID)};
static const uint8_t system_id_value[] = {0x47,0x30,0x34,0x30,0x55,0x34,0x30,0x36,0x39,0x35,0x33,0x32,0x30,0x39,0x4a,0x42};
...
const ATT_TABLE_TYPE Att_List[] =
{
	...
	{44,2,CHRCTR_MANUFACTURE_NAME,14,manufacture_name_value},
    {45,2,GATT_CHARACTERISTIC,1,READ_PREMITTED_ONLY},
	{46,2,CHRCTR_SOFTWARE,3,software_value},
	{47,2,GATT_CHARACTERISTIC,1,READ_PREMITTED_ONLY},
	{48,2,CHRCTR_HARDWARE,3,hardware_value},
    {49,2,GATT_CHARACTERISTIC,1,READ_PREMITTED_ONLY},
	{50,2,CHRCTR_FIRMWARE,8,firmware_value},
    {51,2,GATT_CHARACTERISTIC,1,READ_PREMITTED_ONLY},
	{52,2,CHRCTR_SERIAL_NUMBER,16,serial_number_value},
	{53,2,GATT_CHARACTERISTIC,1,READ_PREMITTED_ONLY},
	{54,2,CHRCTR_MODEL_NUMBER,10,model_number_value},
    {55,2,GATT_CHARACTERISTIC,1,READ_PREMITTED_ONLY},
	{56,2,CHRCTR_SYSTEM_ID,16,system_id_value},
