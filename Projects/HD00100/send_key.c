...
const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x4A, 0x00, 1, DAXIS_KEY_HANDLE}, // 36 MOVIES
    {0x05, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 PLAY
    {0x0c, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 AMAZON
};
const uint8_t IRKeyBuf[][1] = {
...
const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x63, 0x00, 1, DAXIS_KEY_HANDLE}, // 31 YELLOW
    {0x61, 0x00, 1, DAXIS_KEY_HANDLE}, // 32 BLUE
    {0x5D, 0x00, 1, DAXIS_KEY_HANDLE}, // 33 NETFLIX
    {0x5F, 0x00, 1, DAXIS_KEY_HANDLE}, // 34 PRIME VIDEO
    {0x32, 0x00, 1, DAXIS_KEY_HANDLE}, // 35 disney

    {0x56, 0x00, 1, DAXIS_KEY_HANDLE}, // 36 MOVIES
    {0x05, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 PLAY
    {0x9D, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 AMAZON
};
const uint8_t IRKeyBuf[][1] = {
    {0x00}, // 0
