...
static const uint8_t system_id_value[] = {0x78,0x56,0x34,0x12,0x00,0x00,0x00,0x00};
...
static const uint8_t model_number_value[] = {"D5RDB86"};
//generic access
...
{
 0X05 ,0X0C ,0X09 ,0X01 ,0XA1 ,0X01 ,0X85 ,0X01 ,0X19 
,0X00 ,0X2A ,0X9C ,0X02 ,0X15 ,0X00 ,0X26 ,0X9C ,0X02 
,0X95 ,0X02 ,0X75 ,0X10 ,0X81 ,0X00 ,0XC0 ,0X05 ,0X01 
,0X09 ,0X06 ,0XA1 ,0X01 ,0X85 ,0X02 ,0X05 ,0X07 ,0X19 
,0X00 ,0X29 ,0XFF ,0X95 ,0X04 ,0X75 ,0X08 ,0X81 ,0X00 
,0XC0 ,0X06 ,0X01 ,0XFF ,0X09 ,0X02 ,0XA1 ,0X02 ,0X85 
,0X04 ,0X09 ,0X04 ,0X75 ,0X08 ,0X95 ,0X02 ,0X91 ,0X02 
,0XC0
};
...
static const uint8_t report3_rr[] = {0x04, 0x02};
...
static const uint8_t product_id_s[] = "418";
const ATT_TABLE_TYPE Att_List[] =
{
	...
	{60,2,GATT_CHARACTERISTIC,1,READ_NOTIFY_PREMITTED}, //ccc2
	{61,2,CHRCTR_REPORT,1,report_value},
	{62,2,CHARACTERTIC_CONFIGURATION,2,report2_ccc},
	{63,2,REPORT_REFERENCE,2,report2_rr},

	{64,2,GATT_CHARACTERISTIC,1,READ_WRITE_WRITE_WITHOUT_RESPONSE_PREMITTED}, //ccc 3
