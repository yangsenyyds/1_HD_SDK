...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0xEA, 0x00, 2, 64}, // VOL- 31
    {0x21, 0x02, 2, 64}, //VOICE
    {0x9D, 0x00, 2, 64}, //CH-
    {0x61, 0x00, 2, 64}, //LLEFT
    {0xE2, 0x00, 2, 64}, //ZANTING

    {0xCB, 0x01, 2, 64}, // LRIGHT 36
    {0xFA, 0x00, 2, 64}, // MTS
    {0x10, 0x02, 2, 64}, // ZANTING
    {0xE0, 0x01, 2, 64}, // APPS
    {0xA9, 0x00, 2, 64}, // NETF
...
{
 0x02 ,0x01 ,0x05 ,0x03 ,0x03 ,0x12 ,0x18 ,0x0B ,0xFF ,0x0D 
,0x00 ,0x38 ,0x38 ,0x02 ,0x00 ,0x00 ,0x01 ,0xFF ,0x4E ,0x03 
,0x19 ,0x80 ,0x01
};
static const uint8_t scan_rsp_data_buf[] = 
{
 0x08 ,0x09 ,0x48 ,0x69 ,0x73 ,0x65 ,0x6E ,0x73 ,0x65 ,0x11 
,0xFF ,0x0D ,0x00 ,0xFF ,0xFF ,0x45 ,0x52 ,0x46 ,0x33 ,0x46 
,0x38 ,0x30 ,0x56 ,0x31 ,0x2E ,0x30 ,0x32
};
