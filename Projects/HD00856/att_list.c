...
static const uint8_t device_name[] = {"Hisense"};
...
static const uint8_t model_number_value[] = {0x48, 0x69, 0x73, 0x65, 0x6e ,0x73 ,0x65 ,0x00};
//generic access 
...
static const uint8_t Serial_number_string_value[] = {"202109270000"};
static const uint8_t CHRCTR_Firmware_Revision_String[] = {UUID2ARRAY(UUID_CHRCTR_FIRMWARE)};
static const uint8_t Firmware_Revision_String_value[] = {0x56, 0x31, 0x2e, 0x30 ,0x00};
static const uint8_t CHRCTR_Hardwar_Revision_String[] = {UUID2ARRAY(UUID_CHRCTR_HARDWARE)};
static const uint8_t Hardwar_Revision_String_value[] = {0x56 ,0x31, 0x2e ,0x30, 0x00,};

static const uint8_t CHRCTR_Software_Revision_String[] = {UUID2ARRAY(UUID_CHRCTR_SOFTWARE)};
static const uint8_t Software_Revision_String_value[] = {0x56 ,0x31 ,0x2e, 0x30 ,0x38 ,0x00};

static const uint8_t CHRCTR_Manufacturer_Name_String[] = {UUID2ARRAY(UUID_CHRCTR_MANUFACTURE_NAME)};
static const uint8_t Manufacturer_Name_String_value[] = {0x48, 0x69 , 0x73, 0x65, 0x6e ,0x73 ,0x65 ,0x00};
