...
#elif (Project_key == 506 || Project_key == 556 || Project_key == 555)
            if(keynum == 47){
                memset((void*)hid_send_buf, 0, KeyBuf[keynum].key_send_len);
                memcpy((void*)hid_send_buf, (void*)KeyBuf[keynum].keyvalue, 2);
                hid_send_buf[3] = hid_send_buf[1];
