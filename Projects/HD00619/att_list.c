...
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x25,0x04,0x60,0x00};//PRIME_VIDEO_NETFLIX_DISNEP_AMAZONMUSIC
...
static const uint8_t system_id_value[] = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05};
