...
/* SLEEP */
#define ENCRYPT_DONE_DELAY  (15000)      // ms
...
/* SOFTWARE TIMER */
#define TIMER_NUM (15) // KEY 1, LED 1, VBAT 1, VOICE 2, SLEEP 1, REMOTE_CONTROL 6, +1
...
#define MICRECORD_CACHE_MSBC_NUM (10)
#define ENCODE_CACHE_MSBC_NUM (10)
#define ENCODE_INPUT_MSBC_SIZE (240)
#define ENCODE_OUTPUT_MSBC_SIZE (60)
#define AUDIO_SEND_NTF_MSBC_SIZE (60)
#define AUDIO_FRAME_HEADER_MSBC_LEN (2)
// #define AUDIO_SNED_MSBC_HANDLE (70)
// #define AUDIO_SNED_MSBC_HANDLE (70)
#define AUDIO_CMD_HANDLE (76)
#define AUDIO_SNED_MSBC_HANDLE (get_VoiceHandle())
#define AUDIO_CTOL_MSBC_HANDLE (67)

#define VIZIO (1)
#define MSBC (1)
#define AUDIO_MIC_OPEN_BEFORE_HANDLE (70)

#define TIMEOUT_TIME (15000)

#define ADPCM                   (1)
#define AUDIO_CMD_ADCPCM_HANDLE        (149)
#define AUDIO_SNED_ADCPCM_HANDLE       (AUDIO_CMD_ADCPCM_HANDLE+2)
#define AUDIO_CTRL_ADCPCM_HANDLE       (AUDIO_SNED_ADCPCM_HANDLE+3)
#define MICRECORD_CACHE_ADCPCM_NUM     (2)
#define ENCODE_CACHE_ADCPCM_NUM        (10)
#define ENCODE_INPUT_ADCPCM_SIZE       (480)
#define ENCODE_OUTPUT_ADCPCM_SIZE      (120)
#define AUDIO_SEND_NTF_ADCPCM_SIZE     (120)

#define ADCPCM_KEYNUM_HANDLE           (154)
...
typedef enum
{
    ...
    addr_base = 0x3C000,
    device_tag = addr_base,
    device_mibox4_state = addr_base + 0x8,

} FlashRecordAddr_TypeDef; //存储数据需要 8字节
extern uint8_t get_List_state(void);
extern void LE_Master_Feature(uint8_t *data, uint8_t len);
