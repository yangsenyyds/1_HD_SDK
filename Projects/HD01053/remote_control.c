...
// {
// 0x02 ,0x01 ,0x06 ,0x05 ,0xFF ,0x66 ,0x79 ,0x30 
// ,0x01 ,0x02 ,0x0A ,0x03 ,0x0E ,0x09 ,0x54 ,0x43 
// ,0x4C ,0x5F ,0x52 ,0x43 ,0x39 ,0x30 ,0x31 ,0x56 
// ,0x5F ,0x41 ,0x31};
// static const uint8_t scan_rsp_data_buf[] = 
// {0x03 ,0x19 ,0x80 ,0x01};

static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06 ,0x05,0xff,0x66,0x79,0x30,0x01,0x02,0x0a,0x03,0x0e,0x09,0x54,0x43,0x4c,0x5f,0x52,0x43,0x38,0x30,0x32,0x56,0x45,0x55,0x34,0x03,0x19,0x80,0x01};
static uint8_t scan_rsp_data_buf[] = {0x03 ,0x19 ,0x80 ,0x01};
#elif (Project_key == 401)//
static const uint8_t ir_data[] = {
    0x00,
...
// static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06 ,0x05,0xff,0x66,0x79,0x30,0x01,0x02,0x0a,0x03,0x0e,0x09,0x54,0x43,0x4c,0x5f,0x52,0x43,0x38,0x30,0x32,0x56,0x45,0x55,0x34,0x03,0x19,0x80,0x01};
// static uint8_t scan_rsp_data_buf[] = {0x03 ,0x19 ,0x80 ,0x01};
static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06 ,0x05,0xff,0x66,0x79,0x30,0x01,0x0d,0x09,0x54,
0x43,0x4c,0x5f,0x52,0x43,0x38,0x30,0x32,0x56,0x45,0x55,0x03,0x19,0xc1,0x03};
static uint8_t scan_rsp_data_buf[] = {0x0d,0x09,0x54,0x43,0x4c,0x5f,0x52,0x43,0x38,
0x30,0x32,0x56,0x45,0x55};
#elif (Project_key == 402)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0xea, 0x00, 2, 64}, // GREEN  16
    {0x52, 0x00, 2, 64}, // YEELOW
    {0x57, 0x00, 2, 64}, // YOUTUBE
    {0x51, 0x00, 2, 64}, // HOME

};
// static uint8_t adv_data_buf[] = 
// {0x02 ,0x01 ,0x06 ,0x05, 0xff, 0x66, 0x79,0x30, 0x01, 0x02, 0x0a, 0x03, 0x0e, 0x09, 0x54, 0x43, 0x4c, 0x5f, 0x52, 0x43, 0x38,0x30,0x32,0x56,0x4e,0x41,0x31};
// static uint8_t scan_rsp_data_buf[] = {0x03,0x19,0x80,0x01};
...
static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06 ,0x05,0xFF,0x66,0x79,0x30,0x01,0x02,0x0A,0x03,0x0D,0x09,0x54,0x43,0x4C,0x5F,0x52,0x43,0x38,0x30,0x32,0x56,0x45,0x4D,0x03,0x19,0xC1,0x03};
static uint8_t scan_rsp_data_buf[] = {0x03,0x19,0xc1,0x03};
#elif (Project_key == 415)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x9D, 0x00, 4, 35}, // GREEN  16
    {0x00, 0x00, 0, 0}, // YEELOW
    {0x77, 0x00, 4, 35}, // 方框 18
    {0x80, 0x00, 8, 31}, // 
    {0xE2, 0x00, 4, 35}, //  20 静音
...
static uint8_t adv_data_buf[] = {0X0A,0X09,0X52,0X65,0X6D,0X6F,0X74,0X65,0X47,0X31,0X30,0X02,0X01,0X05,0X03,0X19,0X80,0X01,0X05,0X02,0X12,0X18,0X0F,0X18};
static uint8_t scan_rsp_data_buf[] = {0x0A,0x09,0x52,0x65,0x6D,0x6F,0x74,0x65,0x47,0x31,0x30};
#endif
...
static void key_pressed_handle(void)
{
    ...
    {
        if (keynum == Back_Keynum && keynum_second == HOME__Keynum)
        {
            key_pressed_time++;
