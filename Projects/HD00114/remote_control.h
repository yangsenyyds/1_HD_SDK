...
/* SOFTWARE TIMER */
#define TIMER_NUM (15) // KEY 1, LED 1, VBAT 1, VOICE 2, SLEEP 1, MOUSE 2, REMOTE_CONTROL 3, +1
...
#define KEY_COL7_PIN (GPIO_6)
#define KEY_COL8_PIN (GPIO_5)
