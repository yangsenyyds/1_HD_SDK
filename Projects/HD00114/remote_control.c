...
enum
{
    APP_KEY_IDX_PWR = 1,
    APP_KEY_IDX_BACK = 35,
    APP_KEY_IDX_BACK_COL = 2,
    APP_KEY_IDX_HOME = 26,
    APP_KEY_IDX_HOME_COL = 1,
    APP_KEY_IDX_OK = 33,
    APP_KEY_IDX_SET = 36,
    APP_KEY_IDX_SET_COL = 3,
    APP_KEY_IDX_VOICE = 25,
};
#if LG22
...
static void keyvalue_handle(key_report_t *key_report)
{
    ...
    else if (key_pressed_num == 2)
    {
        ...
        if (key_report->keynum_report_buf[APP_KEY_IDX_HOME_COL] == APP_KEY_IDX_HOME&& key_report->keynum_report_buf[APP_KEY_IDX_BACK_COL] == APP_KEY_IDX_BACK)
        {
            keynum = key_report->keynum_report_buf[APP_KEY_IDX_BACK_COL];
            keynum_secnd = key_report->keynum_report_buf[APP_KEY_IDX_HOME_COL];
            key_pressed_time = 0;
            swtimer_start(brand_pressed_timernum, 1000, TIMER_START_ONCE);
        }
        else if(key_report->keynum_report_buf[APP_KEY_IDX_HOME_COL] == APP_KEY_IDX_HOME&& key_report->keynum_report_buf[APP_KEY_IDX_SET_COL] == APP_KEY_IDX_SET){
            
            keynum = key_report->keynum_report_buf[APP_KEY_IDX_SET_COL];
            keynum_secnd = key_report->keynum_report_buf[APP_KEY_IDX_HOME_COL];
            key_pressed_time = 0;
            swtimer_start(brand_pressed_timernum, 1000, TIMER_START_ONCE);
        }
