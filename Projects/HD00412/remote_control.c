...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x52, 0x00, 2, 64}, // GREEN  21
    {0x3A, 0x00, 2, 64}, // YEELOW
    {0x51, 0x00, 2, 64}, // BLUE
    {0x5F, 0x00, 2, 64}, // HOME
    {0x3F, 0x00, 2, 64}, // HOME

    {0x4D, 0x00, 2, 64}, // GREEN  26
    {0x57, 0x00, 2, 64}, // YEELOW
    {0x53, 0x00, 2, 64}, // BLUE
};
static uint8_t adv_data_buf[] = {0x02 ,0x01 ,0x06, 0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x0E, 0x09, 0x54, 0x43, 0x4C, 0x5F, 0x52, 0x43, 0x39, 0x30, 0x32, 0x56, 0x5F, 0x4D, 0x38};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0xc1, 0x03};

#elif (Project_key == 413)//
static const uint8_t ir_data[] = {
    0x00,
...
static const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x38, 0x00, 2, 64}, // GREEN  26
    {0x7D, 0x00, 2, 64}, // YEELOW
    {0x62, 0x00, 2, 64}, // BLUE
};
static uint8_t adv_data_buf[] = {0x02,0x01,0x06,0x05, 0xFF, 0x66, 0x79, 0x30, 0x01, 0x02, 0x0A, 0x03, 0x0E, 0x09, 0x54, 0x43, 0x4C, 0x5F, 0x52, 0x43, 0x39, 0x30, 0x32, 0x56, 0x5F, 0x4D, 0x35};
static uint8_t scan_rsp_data_buf[] = {0x03, 0x19, 0xc1, 0x03};
#endif
