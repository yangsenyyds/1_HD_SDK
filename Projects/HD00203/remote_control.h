...
/* KEY */
#define KEY_ROW1_PIN    (GPIO_36)
#define KEY_ROW2_PIN    (GPIO_29)
#define KEY_ROW3_PIN    (GPIO_24)
#define KEY_ROW4_PIN    (GPIO_14)
#define KEY_ROW5_PIN    (GPIO_13)
#define KEY_ROW_NUM     (5)

#define KEY_COL1_PIN    (GPIO_11)
#define KEY_COL2_PIN    (GPIO_30)
#define KEY_COL3_PIN    (GPIO_9)
#define KEY_COL4_PIN    (GPIO_28)
#define KEY_COL5_PIN    (GPIO_12)
