...
static const uint8_t pnp_id_value[] = {0x02,0x71,0x01,0x14,0x04,0x24,0x00};//PRIMEVIDEO_NETFLIX_ama music apps
...
static const uint8_t firmware_value[] = {"52519901"};//版本号199
