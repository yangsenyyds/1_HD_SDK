...
static void keyvalue_handle(key_report_t *key_report)
{
    ...
    else if (key_pressed_num == 2)
    {
        ...
        if (key_report->keynum_report_buf[1] == APP_KEY_IDX_BACK && key_report->keynum_report_buf[2] == APP_KEY_IDX_HOME)
        {
            keynum = key_report->keynum_report_buf[1];
