...
#elif (Project_key == 513)//300c 200c
static const IRBuf_TypeDef ir_data[] = {
    {0x00, 0x00},
...
#elif (Project_key == 521)//300u 310u
static const IRBuf_TypeDef ir_data[] = {
    {0x00, 0x00},
...
#elif (Project_key == 554)//200pzk 自定义款
static const IRBuf_TypeDef ir_data[] = {
    {0x00, 0x00},
...
#elif (Project_key == 518) //300e  310c
static const IRBuf_TypeDef ir_data[] = {
    {0x00, 0x00},
...
#elif (Project_key == 520) //300e  310p
static const IRBuf_TypeDef ir_data[] = {
    {0x00, 0x00},
...
static void audio_data_handle(void)
{
    ...
    {
        DEBUG_LOG_STRING("keyscan_state_cnt enter_deep_sleep\r\n");
        keyscan_state_cnt = 0;
        // mic_close();
        SysTick_DelayMs(100);
        enter_deep_sleep();
