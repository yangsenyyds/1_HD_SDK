...
/* SOFTWARE TIMER */
#define TIMER_NUM (13) // KEY 1, LED 1, VBAT 1, VOICE 2, SLEEP 1, REMOTE_CONTROL 6, +1
...
#define ENCODE_INPUT_SIZE (344)
#define ENCODE_OUTPUT_SIZE (261)

#define SONY_200            (1)
#define KEYSCAN_STC_CNT_MAX (300 - 1) /// tick 100ms
