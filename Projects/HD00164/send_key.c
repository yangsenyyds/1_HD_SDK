...
#if (LG_Project == 110)//lg21 watcam   185
const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0xC9, 0x00, 1, DAXIS_KEY_HANDLE}, // 36 WATCHA
...
#elif (LG_Project == 152)//lg 21 FAV ? 191
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
...
#elif (LG_Project == 153)//  21  lg channel -//LIST 190
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
...
#elif (LG_Project == 154)//lg21  rakuten tv  170
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
...
#elif (LG_Project == 155)//lg21  movies 224 
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
...
#elif (LG_Project == 150)//lg22 rakuten tv
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
...
#elif (LG_Project == 151)//lg22 lg channels
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
...
#elif (LG_Project == 162)//lg22  movies list guide /1
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
    ...
    {0xAB, 0x00, 1, DAXIS_KEY_HANDLE}, // 11 list guide /1
    {0x10, 0x00, 1, DAXIS_KEY_HANDLE}, // 12 '0'
    {0x45, 0x00, 1, DAXIS_KEY_HANDLE}, // 13 '...'
    {0x02, 0x00, 1, DAXIS_KEY_HANDLE}, // 14 VOL+
    {0x00, 0x00, 1, DAXIS_KEY_HANDLE}, // 15 CH+
...
#elif (LG_Project == 164)//lg21  movies 224 
const KeyBuf_TypeDef KeyBuf[] = {
    {0x00, 0x00, 0, 0}, // 0
