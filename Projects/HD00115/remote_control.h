...
/* SOFTWARE TIMER */
#define TIMER_NUM (14) // KEY 1, LED 1, VBAT 1, VOICE 2, SLEEP 1, MOUSE 2, REMOTE_CONTROL 3, +1
...
#define KVCMD_LG23GA (E_APP_TV_TPYE_13 | E_APP_TV_TPYE_17 | E_APP_TV_TPYE_19 | E_APP_TV_TPYE_90)
