...
const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x63, 0x00, 1, DAXIS_KEY_HANDLE}, // 31 YELLOW
    {0x61, 0x00, 1, DAXIS_KEY_HANDLE}, // 32 BLUE
    {0x5D, 0x00, 1, DAXIS_KEY_HANDLE}, // 33 HOME
    {0x5F, 0x00, 1, DAXIS_KEY_HANDLE}, // 34 MOVIES
    {0x32, 0x00, 1, DAXIS_KEY_HANDLE}, // 35 ?

    {0x81, 0x00, 1, DAXIS_KEY_HANDLE}, // 36 FAV
    {0x05, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 PLAY
    {0x0c, 0x00, 1, DAXIS_KEY_HANDLE}, // 38 AMAZON
...
const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x49, 0x00, 1, DAXIS_KEY_HANDLE}, // 36 rakuten tv
    {0x48, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 PLAY
    {0x0c, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 AMAZON
...
const KeyBuf_TypeDef KeyBuf[] = {
    ...
    {0x48, 0x00, 1, DAXIS_KEY_HANDLE}, // 36 rakuten tv
    {0x6F, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 PLAY
    {0x0c, 0x00, 1, DAXIS_KEY_HANDLE}, // 37 AMAZON
