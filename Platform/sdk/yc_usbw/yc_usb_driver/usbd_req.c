...
#ifndef _YC11XX_USBD_REQ_C_
#define _YC11XX_USBD_REQ_C_
...
/**
 * @method USBD_VID /USBD_PDID
 * @brief  USBD_VID /USBD_PDID
 * @param  None
 * @retval None
*/
...
/**
 * @method USBD_GetDescriptor /USBD_PDID
 * @brief  USBD_GetDescriptor /USBD_PDID
 * @param  None
 * @retval None
*/
...
USBD_Status  USBD_StdDevReq (USB_OTG_CORE_HANDLE  *pdev, USB_SETUP_REQ  *req)
{
    ...
    case USB_REQ_CLEAR_FEATURE:
        if(req ->bmRequest == USB_REQ_VENDOR)
        {
                            ...
                            USB_SETUP_REQ *req)
{
    ...
    if ((req->wIndex == 0) && (req->wLength == 0))
    {
        ...
        else
        {
            ...
            //      USBD_CtlSendStatus(pdev);
            HWRITE(core_usb_addr, Address_Value);
            USBD_CtlSendStatus(pdev);
            //      //MyPrintf("address = %x\n",Address_Value);
            if (dev_addr != 0)
            {
                            ...
                            USB_SETUP_REQ *req)
{
    ...
    //           ((req->wIndex & 0xFF) == 0))
    //    {
    //       dctl.d8 = HREAD(&pdev->regs.COMMREGS->TESTMODE);
    //        dctl.d8 = 0;
