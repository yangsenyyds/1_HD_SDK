...
void EncPacking(SBC_ENC_PARAMS *pstrEncParams)
{
    ...
    SINT32 s32NumOfSubBands = 8; //pstrEncParams->s16NumOfSubBands;
    SINT32 s32NumOfChannels = 1; //pstrEncParams->s16NumOfChannels;
...
//    }
    ...
    *pu8PacketPtr = 26; //(UINT8)(pstrEncParams->s16BitPool & 0x00FF);
...
//#endif
    ...
    s32Sb=8; //s32NumOfChannels*s32NumOfSubBands;
    /*Temp=*pu8PacketPtr;*/
    ...
    /*Temp=*pu8PacketPtr;*/
    s32NumOfBlocks= 15; // pstrEncParams->s16NumOfBlocks;
    for (s32Blk = 14; /*s32NumOfBlocks-1; */ s32Blk >=0; s32Blk--)
    {
        ps16GenPtr  = pstrEncParams->as16Bits;
        ps16ScfPtr  = pstrEncParams->as16ScaleFactor;
        for (s32Ch = 7; /*s32Sb-1;*/ s32Ch >= 0; s32Ch--)
        {
