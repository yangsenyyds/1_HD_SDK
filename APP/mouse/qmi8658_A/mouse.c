...
#endif
        swtimer_start(mouse_report_timernum, SENSOR_REPORT_INTERVAL_TIME, TIMER_START_ONCE);
...
#endif
    GPIO_Init(MOUSE_INT_PIN, GPIO_Mode_Out_Low);
}
