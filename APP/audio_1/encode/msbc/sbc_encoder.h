...
typedef struct SBC_ENC_PARAMS_TAG
{
    ...
    SINT16 as16ScaleFactor[8]; //[SBC_MAX_NUM_OF_CHANNELS*SBC_MAX_NUM_OF_SUBBANDS];
    ...
    SINT32  s32SbBuffer[120]; //[SBC_MAX_NUM_OF_CHANNELS * SBC_MAX_NUM_OF_SUBBANDS * SBC_MAX_NUM_OF_BLOCKS];

    SINT16 as16Bits[8]; //[SBC_MAX_NUM_OF_CHANNELS*SBC_MAX_NUM_OF_SUBBANDS];
...
SBC_API extern void SBC_Encoder_Init(void);
#ifdef __cplusplus
}
#endif
#endif
